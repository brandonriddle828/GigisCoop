            ...
            if (breedSelector.getValue().toString().length() > 0 && henCount.getText().toString().length() > 0 && roosterCount.getText().length() > 0 && hatchDatePicker.getValue().toString().length() > 0)
            {
                    try
                    {
                        ...
                        try
                        {
                             ...
                             String query = "UPDATE Flock SET Hens = " + henCount.getText() + " + " + group.henNum + ",  Roosters = " + roosterCount.getText() + " + " + group.roosterNum + ", Hatch_Date = CONCAT(hatch_Date,   '   |   "+ hatchDatePicker.getValue().toString()+ "')  WHERE flockID = "+ group.flockID +";";

...
public class FixedRemoveMemberController implements Initializable
{
    private Stage stage;
    private Scene scene;
    private Parent root;
            ...
            if (breedSelector.getValue().toString().length() > 0 && henCount.getText().toString().length() > 0 && roosterCount.getText().length() > 0)
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        String query = "UPDATE NewFlock " +
                                "SET Hens = " + group.henNum + " - " + henCount.getText() +
                                ",  Roosters = " + group.roosterNum + " - " + roosterCount.getText()  + "," +
                                "Chicks = " + group.chickNum + " - " + chickCount.getText() + "," +
                                "Pullets = " + group.pulletNum  + " - " + pulletCount.getText() + "," +
                                "Cockerels = " + group.cockerelNum  + " - " + cockerelCount.getText() + "  " +
